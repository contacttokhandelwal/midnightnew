...
<html lang="en-US">
    ...
    <head>
        <meta charset="utf-8">
        <title>
            MNG - The most spectacular website is coming soon !
        ...
        <meta content="The most spectacular website is coming soon !" name="description">
        <meta content="Comming Soon, Responsive, Landing Page, One Page" name="keywords"><!-- Open Graph Meta Data -->
        <meta content="The most spectacular website is coming soon !">
        ...
        <meta content="Imminent - The most spectacular website is coming soon !" name="twitter:description">
        ...
        <div class="wrapper">
            <ul class="scene unselectable" data-friction-x="0.1" data-friction-y="0.1" data-scalar-x="25" data-scalar-y="15" id="scene">
                ...
                <li class="layer" data-depth="0.30">
                    <div class="hero">
                        <h1 id="countdown">
                            The most spectacular website is coming soon !
                        </h1>
...
<!--                        <ul class="icons">
                        ...
                        Team The Midnight Gifts
                        <a class="mail" href="mailto:info@themidnightgifts.com?subject=Hi%20MNG!">info@themidnightgifts.com</a>
                    </div>
                </li>
            </ul>
        </div>
